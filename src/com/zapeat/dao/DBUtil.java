...
public class DBUtil extends SQLiteOpenHelper {
	...
	private final String CREATE_TABLE_PROMOCAO = "CREATE TABLE PROMOCOES (ID INT,DESCRICAO TEXT,LATITUDE TEXT, LONGITUDE TEXT,LOCALIDADE TEXT,DATA_ANUNCIO DATE, DATA_FINAL TEXT, HORA_FINAL TEXT,PRECO_ORIGINAL TEXT,PRECO_PROMOCIONAL TEXT);";
